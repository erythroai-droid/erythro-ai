...
export default function Navbar({ currentLocale, setLocale, theme, setTheme }: NavbarProps) {
      ...
      */}
      <div className="w-full navbar-pill pointer-events-auto transition-all duration-500 ease-out shadow-lg text-white">
        ...
        <button
          ...
          className="lg:hidden p-1.5 focus:outline-none cursor-pointer flex flex-col justify-center items-center gap-1.5 z-50"

      ...
      },
      {
        ...
        paragraphs: {
          en: [
            ...
            'The AI chat consultant answers general questions anonymously and stores nothing. If you ask us to prepare a project brief or to escalate a technical question, we confirm your email with a one-time code and — for a brief — also ask for a phone number; the chat transcript is then stored for up to 12 months so the team can see the context. You are told this in the chat before contact details are requested, and you may ask us to delete the transcript earlier.',
          ...
          ru: [
            ...
            'ИИ-консультант в чате отвечает на общие вопросы анонимно и ничего не сохраняет. Если вы просите составить ТЗ на проект или передать технический вопрос специалисту, мы подтверждаем ваш email одноразовым кодом, а для ТЗ дополнительно запрашиваем телефон; после этого переписка хранится до 12 месяцев, чтобы команда видела контекст. Об этом сообщается в чате до запроса контактов, и вы можете попросить удалить переписку раньше.',
          ...
          he: [
            ...
            'עוזר ה-AI בצ׳אט משיב על שאלות כלליות באופן אנונימי ואינו שומר דבר. אם תבקשו לבנות מסמך אפיון לפרויקט או להעביר שאלה טכנית למומחה, נאמת את כתובת האימייל בקוד חד-פעמי, ולצורך אפיון נבקש גם מספר טלפון; לאחר מכן השיחה נשמרת עד 12 חודשים כדי שהצוות יראה את ההקשר. הדבר נמסר בצ׳אט לפני בקשת פרטי הקשר, ואפשר לבקש למחוק את השיחה מוקדם יותר.',
